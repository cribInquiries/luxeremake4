...
export const properties: Property[] = [
  ...
  {
    slug: "south-terrace-apartment",
    labelName: "South Terrace",
    title: "Modern South Terrace Apartment",
    category: "Property Management",
    tags: ["Styling", "Renovation"],
    description: "Adelaide CBD luxury",
    beds: 2,
    baths: 1,
    status: "active",
    img: houseSixImg1,
    subheading: "Stunning Adelaide CBD apartment with modern styling and city views",
    location: "Adelaide CBD",
